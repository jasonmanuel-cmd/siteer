        ...
        <>
            ...
            <main className="er-container" style={{ padding: "64px 0 0", maxWidth: 860 }}>
                <article>
                    ...
                    <h1 style={{ fontSize: "clamp(2.2rem, 5vw, 3.8rem)", lineHeight: 1.0, letterSpacing: "-.055em", marginBottom: 20 }}>5 Website Mistakes That Cost Local Businesses the Most</h1>
                    <p style={{ color: "var(--er-muted)", fontSize: "1.1rem", lineHeight: 1.75, marginBottom: 48, maxWidth: 700 }}>Most local sites don’t fail because of one huge problem. They leak leads through a stack of small issues: weak mobile usability, missing trust proof, slow pages, vague offers, and calls to action that don’t tell people what to do next.</p>
                    ...
                    <section style={{ borderRadius: 24, padding: 28, background: "rgba(255,255,255,.04)", border: "1px solid rgba(255,255,255,.1)", marginBottom: 40 }}>
                        ...
                        <ol style={{ display: "grid", gap: 14, listStyle: "none", padding: 0, margin: 0 }}>
                            {["Make the mobile hero simple, short, and easy to act on.","Add proof near the first CTA: reviews, logos, real numbers, or results.","Cut page weight by removing unnecessary scripts and oversized media.","Add one clear action per page and repeat it near the footer."].map((item, i) => (
