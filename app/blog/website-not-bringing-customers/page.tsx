...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", headline: "Why Is My Website Not Bringing In Customers?", description: "A simple diagnostic guide for business owners whose site gets traffic but not enough calls.", image: "https://siteer.dev/og-image.png", datePublished: "2025-04-10", dateModified: "2026-05-01", author: { "@type": "Organization", name: "SiteER", url: "https://siteer.dev" }, publisher: { "@type": "Organization", name: "SiteER", url: "https://siteer.dev" }, isPartOf: { "@type": "Blog", name: "SiteER Resources", url: "https://siteer.dev/blog" } };
const breadcrumbSchema = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "SiteER", item: "https://siteer.dev" }, { "@type": "ListItem", position: 2, name: "Blog", item: "https://siteer.dev/blog" }, { "@type": "ListItem", position: 3, name: "Why Is My Website Not Bringing In Customers?", item: "https://siteer.dev/blog/website-not-bringing-customers" }] };
        ...
        <>
            ...
            <main className="er-container" style={{ padding: "64px 0 0", maxWidth: 860 }}>
                <article>
                    ...
                    <h1 style={{ fontSize: "clamp(2.2rem, 5vw, 3.8rem)", lineHeight: 1.0, letterSpacing: "-.055em", marginBottom: 20 }}>Why Is My Website Not Bringing In Customers?</h1>
                    <p style={{ color: "var(--er-muted)", fontSize: "1.1rem", lineHeight: 1.75, marginBottom: 48, maxWidth: 700 }}>When a site gets visits but not customers, the problem is usually not traffic. It is clarity, trust, friction, or the absence of a strong next step. Here’s how to diagnose it in under 10 minutes.</p>
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 18, marginBottom: 40 }}>
                        {[["🎯 Clarity","People should know what you do, who it’s for, and why it matters in under ten seconds. If they can’t, they leave.","var(--er-cyan)"],["⭐ Trust","Add proof close to the CTA: testimonials, logos, guarantees, or real numbers. Without proof, even interested visitors hesitate.","var(--er-green)"],["🚪 Friction","Shorter forms, faster pages, and simpler navigation almost always help. Each extra step loses 10–20% of people.","var(--er-orange)"],["💬 Offer strength","If the offer sounds generic, it won’t create urgency. Specific beats vague every time.","var(--er-red)"]].map(([title, desc, color]) => (
                    ...
                    <section style={{ borderRadius: 24, padding: 28, background: "rgba(255,255,255,.04)", border: "1px solid rgba(255,255,255,.1)", marginBottom: 40 }}>
                        ...
                        <ol style={{ display: "grid", gap: 14, listStyle: "none", padding: 0, margin: 0 }}>
                            {["Read the hero out loud. If it’s vague, rewrite it to answer: what, who, why in one sentence.","Check the first CTA. If it’s not obvious and specific, tighten the offer.","Review the page on a phone. If it feels crowded or slow, simplify and compress.","Make sure there’s a next step at every major scroll point — not just at the top."].map((item, i) => (
